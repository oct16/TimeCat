...
import { emitterHook, getTime, nodeStore, uninstallStore, isVNode, isExistingNode } from '@timecat/utils'
import {
    WatcherOptions,
    RecordEvent,
    RecordType,
...
export function DOMWatcher(options: WatcherOptions<DOMRecord>) {
